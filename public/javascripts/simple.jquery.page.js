        ...
        fillHtml:function(obj,args){
            return (function(){
                ...
                if(args.current != args.pageCount && args.current < args.pageCount -2  && args.pageCount != 4){
                    if(args.pageCount != 500 && !args.isDN){
                        obj.append('<a href="javascript:;" class="tcdNumber">'+args.pageCount+'</a>');
                    }else if(args.pageCount == 500 && args.current == 500){
                        obj.append('<a href="javascript:;" class="tcdNumber">'+args.pageCount+'</a><span>...</span>');
                    }
                }
                //下一页
        ...
        bindEvent:function(obj,args){
            return (function(){
                obj.off("click","a.tcdNumber").on("click","a.tcdNumber",function(){
                    ...
                    if(current > args.maxPage){
                        args.maxPageFn();
                        return;
                    }
                    if(typeof(args.backFn)=="function"){
                        if(args.backFn(current)){
                            return;
                        }
                    }
